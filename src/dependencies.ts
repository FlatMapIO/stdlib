...
export const inputs = dependency(
  "@observablehq/inputs",
  "0.10.4",
  "dist/inputs.min.js",
);
export const plot = dependency(
  "@observablehq/plot",
  "0.6.3",
  "dist/plot.umd.min.js",
);
export const graphviz = dependency(
  "@observablehq/graphviz",
  "0.2.1",
  "dist/graphviz.min.js",
);
export const highlight = dependency(
  "@observablehq/highlight.js",
  "2.0.0",
  "highlight.min.js",
);
export const katex = dependency(
  "@observablehq/katex",
  "0.11.1",
  "dist/katex.min.js",
);
...
export const vegalite = dependency(
  "vega-lite",
  "5.6.0",
  "build/vega-lite.min.js",
);
export const vegaliteApi = dependency(
  "vega-lite-api",
  "5.0.0",
  "build/vega-lite-api.min.js",
);
export const arrow4 = dependency(
  "apache-arrow",
  "4.0.1",
  "Arrow.es2015.min.js",
);
...
export const topojson = dependency(
  "topojson-client",
  "3.1.0",
